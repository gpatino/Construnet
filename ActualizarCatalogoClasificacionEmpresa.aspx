<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ActualizarCatalogoClasificacionEmpresa.aspx.cs" Inherits="ConstrunetUnlimited.ActualizarCatalogoClasificacionEmpresa" %>
                ...
                <div class="row">
                	<div class="col-xs-12 col-sm-9 col-md-9 col-lg-9">
			            ...
			            <!-- PAGE HEADER -->
				            ...
				            Actualizar Clasificación Empresa
		                </h1>
	            </div>
				            ...
				            <div>
					            ...
					            <div class="widget-body no-padding">
						            ...
						            <div id="smart-form-register" class="smart-form">
							            ...
							            <footer>
                                            <asp:Button ID="UpdateClasificacionEmpresaBtn" runat="server" Text="Actualizar" OnClick="UpdateClasificacionEmpresaBtn_Click" CssClass="btn btn-success" />
