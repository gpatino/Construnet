<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AddCatalogoSector.aspx.cs" Inherits="ConstrunetUnlimited.AddCatalogoSector" %>
				            ...
				            <div>
					            ...
					            <div class="widget-body no-padding">
						            ...
						            <div id="smart-form-register" class="smart-form">
							            ...
							            <footer>
                                            <asp:Button ID="AddSectorBtn" runat="server" Text="Registrar" OnClick="AddSectorBtn_Click" CssClass="btn btn-success" />
