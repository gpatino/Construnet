<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ActualizarCatalogoEstatusProyecto.aspx.cs" Inherits="ConstrunetUnlimited.ActualizarCatalogoEstatusProyecto" %>
				            ...
				            <div>
					            ...
					            <div class="widget-body no-padding">
						            ...
						            <div id="smart-form-register" class="smart-form">
							            ...
							            <footer>
                                            <asp:Button ID="UpdateEstatusProyectoBtn" runat="server" Text="Actualizar" OnClick="UpdateEstatusProyectoBtn_Click" CssClass="btn btn-success" />
