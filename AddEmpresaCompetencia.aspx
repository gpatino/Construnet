<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AddEmpresaCompetencia.aspx.cs" Inherits="ConstrunetUnlimited.AddEmpresaCompetencia" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
		...
		<div id="main" role="main">
			...
			<div id="ribbon">
				...
				<!-- breadcrumb -->
				<ol class="breadcrumb">
					<li>Home</li><li>Proyectos</li><li><a href="EmpresasCompetencia.aspx"> Empresas Competencia</a></li><li>Agregar Empresa Competencia</li>
				</ol>
				<!-- end breadcrumb -->
				            ...
				            <div>
					            ...
					            <div class="widget-body no-padding">
						            ...
						            <div id="smart-form-register" class="smart-form">
								            ...
								            <div class="row">
									            <section class="col col-3">
									                <label class="input"> <i class="icon-append fa fa-pencil"></i>
										                <asp:TextBox ID="empresacompetenciatxt" runat="server" placeholder="Nombre de la Empresa Competencia" AutoPostBack="true" OnTextChanged="empresacompetenciatxt_TextChanged" ></asp:TextBox></label>
                                                        <div class="note note-error"><asp:RequiredFieldValidator ID="empresaValidator" runat="server" ControlToValidate="empresacompetenciatxt" SetFocusOnError="true" InitialValue="" ErrorMessage="Ingresar Empresa Competencia es requerido" ForeColor="Red"></asp:RequiredFieldValidator></div>
									            </section>
                                                <section class="col col-3">
                                                     <asp:Repeater ID="rptEmpresas" runat="server" Visible="false">
                                                            <HeaderTemplate>
                                                                ...
                                                                <table id="dt_basic" class="table table-striped table-bordered table-hover" >
												                    ...
												                    <tr>
													                    ...
													                    <th style="text-align:center"> Empresa Competencia</th>
												                    </tr>
											                    </thead>
											                    <tbody>
                                                            </HeaderTemplate>
                                                            <ItemTemplate>  
												                <tr>
													                <td style="text-align:center"><%# Eval("IdEmpresaCompetencia") %></td>
													                <td style="text-align:center"><%# Eval("nombreEmpresaCompetencia") %></td>
                                                            </ItemTemplate>
                                                            <FooterTemplate>
												                </tr>
											                    </tbody>
							            ...
							            <footer>
                                            <asp:Button ID="AddEmpresaCompetenciaBtn" runat="server" Text="Registrar" OnClick="AddEmpresaCompetenciaBtn_Click" CssClass="btn btn-success" />
                                            <asp:HyperLink ID="EndButton" runat="server" Text="Finalizar" CssClass="btn btn-success" NavigateUrl="~/EmpresasCompetencia.aspx"/>
                                            <asp:HyperLink ID="CancelButton" runat="server" Text="Cancelar" CssClass="btn btn-danger" NavigateUrl="~/EmpresasCompetencia.aspx"/>
							            </footer>
						            </div>						
