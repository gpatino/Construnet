<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AddCatalogoZonasVenta.aspx.cs" Inherits="ConstrunetUnlimited.AddCatalogoZonasVenta" %>
				            ...
				            <div>
					            ...
					            <div class="widget-body no-padding">
						            ...
						            <div id="smart-form-register" class="smart-form">
							            ...
							            <footer>
                                            <asp:Button ID="AddZonaVentaBtn" runat="server" Text="Registrar" OnClick="AddZonaVentaBtn_Click" CssClass="btn btn-success" />
