<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ActualizarCatalogoEtapaProyecto.aspx.cs" Inherits="ConstrunetUnlimited.ActualizarCatalogoEtapaProyecto" %>
				            ...
				            <div>
					            ...
					            <div class="widget-body no-padding">
						            ...
						            <div id="smart-form-register" class="smart-form">
							            ...
							            <footer>
                                            <asp:Button ID="UpdateEtapaProyectoBtn" runat="server" Text="Actualizar" OnClick="UpdateEtapaProyectoBtn_Click" CssClass="btn btn-success" />
